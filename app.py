...
# ============================================================
# FILE PATHS
# All files are directly in the GitHub repository root.
# ============================================================
...
def make_model_input(
    ...
    """
    Build the same 8 model features used during final training.

    Original_Price and Promotion are user-adjustable inputs
    because those fields are not contained in the compact
    deployment CSV files.
    """
...
if page == "Home":
    ...
    st.markdown(
        ...
        '</div>'
        '<div class="hero-copy">'
        'PriceLens compares a selected grocery price with '
        'comparable observed prices and uses a machine-learning '
        'model to estimate an expected price.'
        '</div>'
        '</div>',
        unsafe_allow_html=True,
    )
    ...
    with left:
        ...
        st.markdown(
            ...
            '</h3>'
            '<div class="muted">'
            'Direct peer-price comparison is the primary evidence '
            'layer. The CatBoost model provides a supporting '
...
# ============================================================
    ...
    f = context_df[
        context_df["Product_Name"].astype(str)
        == product
    ].copy()
    ...
    st.caption(
        ...
        "price and promotion status. These controls keep the "
        "deployed model fully functional without requiring "
    ...
    if st.button(
        ...
        if (
            ...
            result["validated_oof_expected"] = np.nan
